...
class HemaDataset(torch.utils.data.Dataset):
    def __init__(self, root, image_transform=None, target_transform=None, seg_entire_cell=True, split="train"):
        self.root = root
        self.split = split
